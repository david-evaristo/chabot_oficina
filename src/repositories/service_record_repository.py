...
class ServiceRecordRepository:
    ...
    async def search_service_records(self, client_name: str | None = None, car_brand: str | None = None, car_model: str | None = None, service_description: str | None = None) -> list[ServiceRecord]:
