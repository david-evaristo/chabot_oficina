...
class ServiceManagementService:
    ...
    async def create_service_record(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        service_valor = data.service_valor
        service_observations = data.service_observations
        ...
        record = await self.service_repo.create_service_record(
            ...
            date=service_date or datetime.now(timezone.utc).date(),
            valor=service_valor,
    ...
    async def search_service_records(self, search_params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        car_brand = search_params.car_brand
        car_model = search_params.car_model
        service_description = search_params.service_description
